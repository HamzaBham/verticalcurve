...
form.addEventListener('submit', (event) => {
    ...
    let EVCStValue1 =  parseFloat(parseFloat(curveLength1) + parseFloat(BVCStValue));
    let EVCStValue2 =  parseFloat(parseFloat(curveLength2) + parseFloat(BVCStValue));  
    //To print EVC station, EVC elevation, final grade
